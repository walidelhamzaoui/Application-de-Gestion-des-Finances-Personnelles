<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="text-center p-5 ">
            <h3 class="text-xl p-2 font-sans text-white w-95  bg-sky-800 rounded-xl ">Connextion</h3>
        </div>
        <div class="mt-3 mb-5">
...
<div class="flex items-center justify-center">
        <button
            class="flex items-center justify-center  py-2.5 px-20 bg-cyan-950 hover:bg-gray-500 focus:ring-blue-500 focus:ring-offset-blue-500 text-white w-95 transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-xl">
            <svg viewBox="0 0 24 24" height="25" width="25" y="0px" x="0px" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    ...
                    fill="#E6E6E6"></path>
                <path opacity=".2"
                    d="M12,9.5v0.25h11.7855721c-0.0157471-0.0825195-0.0329475-0.1680908-0.0503426-0.25H12z" fill="#FFF">
                </path>
        ...
        <div class="text-center my-3 p-3 w-full ">
            <x-primary-button class=" w-80 py-3  flex bg-sky-800 text-lg rounded-xl  justify-center items-center">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
        <div class="flex items-center justify-between mt-4">
            ...
            <a href="{{route('register')}}" class="ms-3 bg-blue-950 py-2 px-4 underline text-white rounded-md">
                {{ __('Sign Up') }}
            </a>
        </div>
    </form>
