<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="text-center p-4 ">
            <h3 class="text-xl p-2 font-sans text-white w-95  bg-sky-800 rounded-xl text-base font-semibold shadow-md  ">Inscription</h3>
        </div>
        <div>
...
<div class="flex items-center justify-center  mt-4">
            <x-primary-button class="ms-4 py-3   flex bg-sky-800 flex justify-center items-center text-center w-64">
                {{ __('Register') }}
            </x-primary-button>
        </div>
