...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="d-flex justify-content-between mt-3 my-5">
            ...
            <a href="{{route('transaction.create')}}" class="text-end btn btn-dark">Create transaction </a>
        </div>
        ...
        <div class="form-group col-lg-3 col-md-6 col-9 mb-3  position-relative">
                ...
                <a href="{{route('transaction.index')}}"> <button type="submit"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex gap-2 ">
                                    <a href="{{route('transaction.edit',$transaction->id)}}"> <button
